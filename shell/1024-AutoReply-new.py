...
userid : str = os.environ["CAPTCHA_USERID"]
apikey : str = os.environ["CAPTCHA_APIKEY"]

#用户名 密码 2FA密钥 多个账号用空格分隔
user : str = os.environ["cl_user2"]
password : str = os.environ["cl_password2"]
secret : str = os.environ["cl_secret2"]
